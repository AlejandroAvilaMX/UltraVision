 ...
 * Search tool will be available and it will use the Name of the CD as the filter.
 * 
...
public class MC extends JFrame implements ActionListener{
	...
	//This method will delete the CD Music
	public void deleteCDMusic() {
		ConectionDB con = new ConectionDB();
        Connection conection = con.conect();
	...
	//This method will update the details of a CD Music
	public void updateCDMusic() {
	...
	//This method will send the information of the CD Music to be updated
	...
	//This method will save a new CD Music
	public void saveCDMusic() {
		//Validation of required fields
    	if(name.getText().equals("") || releaseYear.getText().equals("") || artist.getText().equals("") || stock.getText().equals("") || available.getText().equals("") || rentPrice.getText().equals("")) {
    		JOptionPane.showMessageDialog(null, "One or more required fields are empty, please check: \n"
    				+ "	  � Name\n"
	...
	//This method will send the information of the new CD Music to be inserted
